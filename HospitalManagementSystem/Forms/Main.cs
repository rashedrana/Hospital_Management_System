...
namespace HospitalManagementSystem.Windows
{
    public partial class Main : Form
    {
        ...
        private void apnBtn_Click(object sender, EventArgs e)
        {

        }

        private void phrBtn_Click(object sender, EventArgs e)
        {
        ...
        private void txtLoggedInAs_TextChanged(object sender, EventArgs e)
        {
